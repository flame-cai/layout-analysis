...
def main():
    ...
    # Check dimensions of node features to initialize model
    ...
    # First: Train on all pages
    print("\nTraining model on all pages...")
    for epoch in range(num_epochs):
        epoch_loss = 0.0
        
        # Train on each page for this epoch
        ...
        # Average loss across all pages
        avg_epoch_loss = epoch_loss / len(all_data)
    ...
    # Second: Test and visualize for each page
    print("\nEvaluating and visualizing results for each page...")
    for page_idx, data in enumerate(all_data):
        page_num = page_idx
