...
def process_image(folder_path):
    ...
    test_data_path = '/home/kartik/layout-analysis/stress-test-data/'
...
parser.add_argument('--path', type=str, help='The path to folder which contains leaf images', default="/home/kartik/layout-analysis/stress-test-data")
# /mnt/cai-data/layout-analysis/manuscripts/DMV/leaves
